...
This repo is the administrative brain for the CAMEL NSF grant. Claude should use these lookup rules when answering questions:
...
When Becca provides meeting notes or voice captures:
1. Format into `grant/meetings/YYYY-MM-DD-topic.md`
2. Flag any deliverable status changes (on-track → at-risk, or done)
3. Extract decisions → ask if they should go to `decisions/`
4. Propose STATE.json diff — show before confirming write
